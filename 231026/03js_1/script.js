...
//2가지 나눠서 
//1) 고전적인 방식 생성사 함수를 활용해서 객체를 생성하는 방법
//2) Class를 활용한 생성자 함수 만들어서 객체를 생성하는 방법
...
//생성자 함수를 통해서 생성된 Book이라는 프로토 타입객체를 활용해서 인스턴스 객체를 만들어보자

const book1 = new Book("해리포터", 1000);
book1.buy();
